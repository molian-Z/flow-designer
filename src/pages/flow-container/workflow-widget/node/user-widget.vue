<template>
  <node-container :class="widget.options.customClass">
    <svg-icon :icon-class="type.widgetConfig.svgFields.icon"></svg-icon>
  </node-container>
