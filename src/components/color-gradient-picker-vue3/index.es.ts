...
const _hoisted_1$6 = { class: "picking-area-overlay1" };
const _hoisted_2$3 = { class: "picking-area-overlay2" };
...
const _hoisted_1$5 = { class: "preview-area" };
...
const _hoisted_1$4 = { class: "alpha-area" };
...
const _hoisted_1$3 = { class: "picker-area" };
const _hoisted_2$2 = { class: "preview" };
const _hoisted_3 = { class: "color-hue-alpha" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        ...
        __props.isGradient ? (openBlock(), createBlock(_sfc_main$8, {
          key: 0,
          type: __props.type,
...
const _hoisted_1$2 = { class: "input-container" };
...
const Input = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-986fef99"]]);
...
const _hoisted_1$1 = { class: "color-preview-area" };
...
const _sfc_main = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues({}, __default__), {
  ...
  setup(__props, { emit: emits }) {
    const props = __props;
    const color = ref();
    color.value = __spreadValues({}, props.color);
    provide("provideData", {
      onChange: (attrs) => {
