export function pdfHtml(params) {
  var el = params.el;
  var domGroup = [];
...
function printStart(params, domGroup) {
  ...
  each(domGroup, function(dom) {
    ...
    var isFirstLevel = ((_b = (_a = dom.parentElement) === null || _a === void 0 ? void 0 : _a.nodeName) === null ||
      _b === void 0 ? void 0 : _b.toLowerCase()) === 'body';
...
function crateStyle(_a, isFull) {
  ...
  @media print {
    ...
    ${isFull?'':'body> :not(.printing),.printing> :not(.is-print) {display: none;zoom:0.15;}'}}`;
